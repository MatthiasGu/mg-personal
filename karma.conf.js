module.exports = function(config) {
    config.set({
        ...
        // Very basic server socket io...
        socketioServer: {
            port: 3001, //default port unless you set something different
        ...
        frameworks: ['socketio-server','jasmine'],
        ...
        preprocessors: {
            ...
            '**/public/factories/*.js': 'coverage',
            '**/public/filters/*.js': 'coverage',
            '**/public/directives/*.js': 'coverage',
            '**/public/modules/**/*.js': 'coverage',
            '**/public/model/**/*.js': 'coverage',
        },
